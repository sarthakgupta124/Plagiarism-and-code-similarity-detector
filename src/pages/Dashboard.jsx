...
const Dashboard = () => {
  ...
  return (
    /* Transparent background to allow SpaceBackground to show through */
        ...
        <div className="mt-8 w-full max-w-2xl bg-black/20 backdrop-blur-sm rounded-xl p-6 border border-white/10">
          ...
          <div className="space-y-2 max-h-60 overflow-y-auto pr-2 custom-scrollbar">
            {files.map((file, index) => (
              <div
                key={index}
                className="flex items-center justify-between bg-white/5 border border-gray-700/50 rounded-lg px-4 py-3"
              >
                <div>
